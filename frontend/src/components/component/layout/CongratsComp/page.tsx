...
export default function CongratsPage () {
  ...
  return (
    ...
    <div className="flex justify-center items-center relative ">
        <div className=" absolute bottom-24 z-1 h-">
        ...
        <div className="relative bottom-14  flex justify-center items-center flex-row top">
            <div className="absolute border-1 rounded-3xl px-12 py-6 w-[30rem] bg-[#16A34A]/13 flex justify-around border-black/25 text-center">
                ...
                <div className="text-[#16A34A]/75 text-[20px] pl-3 justify-center text-center">
