    ...
    return (
        ...
        <div className="bg-[#F8F2DE] w-full h-screen relative">
            <div className="absolute left-30 top-1/3 text-black">
              ...
              <div className="mt-18">
                <a href="/Voting-Page" className=" w-full h-full p-4 bg-red-500 rounded-xl text-white text-2xl hover:bg-amber-50  hover:text-black ease-in duration-300 " >Mulai Voting</a>   
              </div>
